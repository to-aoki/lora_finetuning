...
def loftq_init(model, tokenizer, train_dataset, max_seq_length, args):
    if args.use_loftq_callback:
        ...
        random_inputs = tokenizer(random_inputs, return_tensors="pt", padding=True, truncation="max_length",
...
def main(model_args, data_args, training_args):
    ...
    trainer.save_model()
    output_dir = os.path.join(training_args.output_dir, "final_checkpoints")
